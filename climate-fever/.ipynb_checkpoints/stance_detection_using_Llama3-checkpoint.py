...
class LLMStanceDetector:
    ...
    def get_response_from_api_call(self, text: str, claim: str):
        ...
        example1 = (f"Given claim is: The polar bear population has been growing. "
                   f"Sentences refuting the given claim in the given textual document are: In two areas where harvest levels have been increased based on increased sightings, science-based studies have indicated declining populations, and a third area is considered data-deficient. Of the 19 recognized polar bear subpopulations, one is in decline, two are increasing, seven are stable, and nine have insufficient data, as of 2017. ")
